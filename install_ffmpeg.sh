...
echo "Extraction..."
tar -xf "$ARCHIVE" -C "$FFMPEG_DIR"
LATEST_DIR=$(find "$FFMPEG_DIR" -maxdepth 1 -type d -name 'ffmpeg-*' | sort | tail -n 1)
...
echo "Ajoute ce dossier à ton PATH ou lance: export PATH=\"$BIN_DIR:\$PATH\""
